  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved milestone as @milestone" do
        ...
        post :create, {:milestone => { "name" => "invalid value" }}, valid_session
        assigns(:milestone).should be_a_new(Milestone)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested milestone" do
        ...
        Milestone.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => milestone.to_param, :milestone => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the milestone as @milestone" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Milestone.any_instance.stub(:save).and_return(false)
        put :update, {:id => milestone.to_param, :milestone => { "name" => "invalid value" }}, valid_session
        assigns(:milestone).should eq(milestone)
      end
