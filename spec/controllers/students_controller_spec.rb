  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved student as @student" do
        ...
        post :create, {:student => { "level" => "invalid value" }}, valid_session
        assigns(:student).should be_a_new(Student)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested student" do
        ...
        Student.any_instance.should_receive(:update).with({ "level" => "1" })
        put :update, {:id => student.to_param, :student => { "level" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the student as @student" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Student.any_instance.stub(:save).and_return(false)
        put :update, {:id => student.to_param, :student => { "level" => "invalid value" }}, valid_session
        assigns(:student).should eq(student)
      end
