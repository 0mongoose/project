...
describe QuizzesController do
  ...
  let(:valid_attributes) { { "result" => "1.5" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved quiz as @quiz" do
        ...
        post :create, {:quiz => { "result" => "invalid value" }}, valid_session
        assigns(:quiz).should be_a_new(Quiz)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested quiz" do
        ...
        Quiz.any_instance.should_receive(:update).with({ "result" => "1.5" })
        put :update, {:id => quiz.to_param, :quiz => { "result" => "1.5" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the quiz as @quiz" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Quiz.any_instance.stub(:save).and_return(false)
        put :update, {:id => quiz.to_param, :quiz => { "result" => "invalid value" }}, valid_session
        assigns(:quiz).should eq(quiz)
      end
